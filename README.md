...
```
HDP Notes : Currently the HDP removal scrips works on folder `/user/` and `/hdp/apps/` on HDFS. To add or remove hdfs directories please modify/extent in The `hdp_log4j_jndi_removal.sh` around `line 41`.  
